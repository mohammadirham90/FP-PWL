...
$karakter_pencarian = substr($pencarian, 0, 3);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="content_area">
            ...
            <div id="list_buku">
                <div id="buku">
                    ...
                    <?php
                    $sql = mysqli_query($conn, "select judul_buku from daftar_buku where judul_buku like '%$karakter_pencarian%' order by id asc");
